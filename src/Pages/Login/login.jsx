...
const Login = () => {
    ...
    const url ='https://artartwebapp.herokuapp.com/api/auth/login';
    ...
    return (
        <div className='login-container'>
            ...
            <form className='login-main-container' onSubmit={(e)=>submit(e)}>
                ...
                <Button type={'tertiary'} style={{marginBottom: '16px'}} clickHandler={() => redirect('/resetPassword')}>Забыли пароль?</Button>
                {
